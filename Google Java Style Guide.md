...
클래스의 이름은 일반적으로 명사나 명사구입니다. 예를 들면 Character또는 ImmutableList를 사용합니다. 인터페이스의 이름 또한 명사나 명사구를 사용합니다. 하지만 가끔씩 형용사나 형용사구가 사용되기도 합니다.(ex. Readable )
